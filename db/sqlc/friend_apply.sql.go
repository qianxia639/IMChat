...
func (q *Queries) CreateFriendApply(ctx context.Context, arg *CreateFriendApplyParams) (FriendApply, error) {
	row := q.db.QueryRowContext(ctx, createFriendApply,
		arg.ApplyID,
		arg.ReplyID,
		arg.ApplyDesc,
		arg.Note,
...
func (q *Queries) DeleteFriendApply(ctx context.Context, arg *DeleteFriendApplyParams) error {
	_, err := q.db.ExecContext(ctx, deleteFriendApply, arg.ApplyID, arg.ReplyID)
	return err
}
...
func (q *Queries) GetFriendApply(ctx context.Context, arg *GetFriendApplyParams) (FriendApply, error) {
	row := q.db.QueryRowContext(ctx, getFriendApply, arg.ApplyID, arg.ReplyID)
	var i FriendApply
	err := row.Scan(
		&i.ApplyID,
		&i.ReplyID,
...
func (q *Queries) ListFriendApply(ctx context.Context, replyID int32) ([]ListFriendApplyRow, error) {
	rows, err := q.db.QueryContext(ctx, listFriendApply, replyID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []ListFriendApplyRow{}
	for rows.Next() {
