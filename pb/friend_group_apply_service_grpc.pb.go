...
func (c *friendGroupApplyServiceClient) CreateFriendGroupApply(ctx context.Context, in *CreateFriendGroupApplyRequest, opts ...grpc.CallOption) (*CreateFriendGroupApplyResponse, error) {
	out := new(CreateFriendGroupApplyResponse)
...
func (c *friendGroupApplyServiceClient) ReplyFriendGroupApply(ctx context.Context, in *ReplyFriendGroupApplyRequest, opts ...grpc.CallOption) (*ReplyFriendGroupApplyResponse, error) {
	out := new(ReplyFriendGroupApplyResponse)
...
func (UnimplementedFriendGroupApplyServiceServer) CreateFriendGroupApply(context.Context, *CreateFriendGroupApplyRequest) (*CreateFriendGroupApplyResponse, error) {
