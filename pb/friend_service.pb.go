...
func (x *DeleteFriendResponse) Reset() {
	*x = DeleteFriendResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_friend_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteFriendResponse) Descriptor() ([]byte, []int) {
	return file_friend_service_proto_rawDescGZIP(), []int{5}
}
...
func (x *ListFriendsResponse) Reset() {
	*x = ListFriendsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_friend_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListFriendsResponse) Descriptor() ([]byte, []int) {
	return file_friend_service_proto_rawDescGZIP(), []int{6}
}
...
var file_friend_service_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x66, 0x0a, 0x10, 0x41, 0x64, 0x64, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x52, 0x65,
	...
	0x79, 0x44, 0x65, 0x73, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x6f, 0x74, 0x65, 0x18, 0x03, 0x20,
	...
	0x52, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x32, 0xbb, 0x03, 0x0a, 0x0d, 0x46, 0x72, 0x69,
...
var file_friend_service_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_friend_service_proto_depIdxs = []int32{
	...
	7, // 3: qianxia.IMChat.FriendService.ListFriends:input_type -> google.protobuf.Empty
...
func file_friend_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_friend_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_friend_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
